...
Route::get('/player-set-brightness/{p}', 'MPlayerController@setTimePos')->where(['timePos' => '[\\-0-9]+']);
Route::get('/player-set-contrast/{p}', 'MPlayerController@setTimePos')->where(['timePos' => '[\\-0-9]+']);
Route::get('/player-set-gamma/{p}', 'MPlayerController@setTimePos')->where(['timePos' => '[\\-0-9]+']);
Route::get('/player-set-hue/{p}', 'MPlayerController@setTimePos')->where(['timePos' => '[\\-0-9]+']);
Route::get('/player-set-saturation/{p}', 'MPlayerController@setTimePos')->where(['timePos' => '[\\-0-9]+']);
