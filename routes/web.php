...
Route::get('/player-play-prev-video/{uri}', 'MPlayerController@playPrevVideo')->where(['uri' => '[\s\S]+']);
Route::get('/player-rm-video/{uri}', 'MPlayerController@rmVideo')->where(['uri' => '[\s\S]+']);
